    ...
    <div class="boxed_wrapper">
        ...
        <style>
            ...
            .preloader {
                width: 100%;
                height: 100%;
                background: radial-gradient(circle at 30% 40%, #2a2a2a, #1a1a1a);
                display: flex;
            ...
            .wave-1 {
                fill: rgba(130, 187, 210, 0.4);
                animation-delay: 0s;
            }

            .wave-2 {
                fill: rgba(130, 187, 210, 0.3);
                animation-delay: -2s;
            }

            .wave-3 {
                fill: rgba(130, 187, 210, 0.2);
                animation-delay: -4s;
            }
            ...
            .liquid-circle {
                position: absolute;
                border-radius: 50%;
                background: radial-gradient(circle, rgba(130, 187, 210, 0.6), transparent);
            ...
            .animated-logo {
                ...
                filter: drop-shadow(0 10px 40px rgba(130, 187, 210, 0.6));
            }
            ...
            .letters-loading {
                ...
                text-shadow:
                    0 0 20px rgba(130, 187, 210, 0.8),
                    0 0 40px rgba(130, 187, 210, 0.5),
            ...
            .progress-wave {
                width: 400px;
                height: 100px;
                background: linear-gradient(90deg, #82bbd2, #ffffff, #82bbd2);
                position: absolute;
                top: -25px;
                left: -100px;
                border-radius: 40%;
                animation: waveProgress 3s ease-in-out infinite;
                box-shadow: 0 0 30px rgba(130, 187, 210, 0.6);
            }
            ...
            .preloader-close {
                ...
                align-items: center;
                justify-content: center;
                background: rgba(130, 187, 210, 0.2);
                backdrop-filter: blur(10px);
                border: 2px solid #82bbd2;
                border-radius: 50%;
            ...
            .preloader-close:hover {
                ...
                box-shadow: 0 8px 30px rgba(130, 187, 210, 0.8);
            }

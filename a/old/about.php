                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image_block_1">
                                <div class="image-box">
                                    <figure class="image image-1 wow fadeInLeft animated" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="assets/images/resource/about-1.jpg" alt="UDAAN Mental Health Initiative"></figure>
                                    <figure class="image image-2 wow fadeInRight animated" data-wow-delay="300ms" data-wow-duration="1500ms"><img src="assets/images/resource/about-2.jpg" alt="Community Mental Health"></figure>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                            <div class="content_block_1">
                                <div class="content-box">
                                    ...
                                    <div class="inner-box">
                                        <figure class="image-box"><img src="assets/images/resource/about-3.jpg" alt="Mental Health Services"></figure>
                                        <div class="inner">
                                            <h5><i class="flaticon-brain"></i>Comprehensive Mental Health Care</h5>
                                            <p>Providing accessible, affordable mental health services through community-based interventions.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="service-block-two wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        ...
                                        <p>Partnership formalized through MoU, marking Tata Trusts' first major commitment to mental health sector.</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                            <div class="service-block-two wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="our-approach.php">2018 - Expansion</a></h3>
                                        <p>New MoU to enhance DMHP through collaborative, decentralized, and holistic community approach.</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                            <div class="service-block-two wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="our-partners.php">2023 - Continued Growth</a></h3>
                                        <p>Extended implementation through 2026, supported by Indira Foundation and RG Mundhe Foundation.</p>
            ...
            <section class="video-section centred" style="background-image: url(assets/images/background/video-bg-1.jpg);">
                <div class="auto-container">
                    ...
                    <div class="inner-box wow zoomIn animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <h2>Mental health care must extend <br />beyond hospital settings into communities.</h2>
                        <div class="video-btn">
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12 content-column">
                            <div class="content_block_4">
                                <div class="content-box">
                                    ...
                                    <div class="text">
                                        <p>UDAAN provides holistic mental health care through screening, treatment, awareness, rehabilitation, and capacity building. With approximately 1,700-1,800 regular service users monthly, our team of psychiatrists, psychologists, social workers, block coordinators, and community health workers brings expertise and compassion to every intervention.</p>
                                    </div>
                                    <div class="inner-box">
                                        <div class="row clearfix">

...
<body>
    ...
    <div class="boxed_wrapper">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image_block_1">
                            <div class="image-box wow fadeInLeft animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <figure class="image image-1"><img src="assets/images/resource/about-1.jpg" alt="UDAAN Community Mental Health"></figure>
                                <figure class="image image-2"><img src="assets/images/resource/about-2.jpg" alt="Mental Health Services Nagpur"></figure>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                        <div class="content_block_1">
                            <div class="content-box wow fadeInRight animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                ...
                                <div class="inner-box">
                                    <figure class="image-box"><img src="assets/images/resource/about-3.jpg" alt="Community Mental Health Care"></figure>
                                    <div class="inner">
                                        <h5><i class="flaticon-brain"></i>Community-Based Mental Health Care</h5>
                                        <p>Delivering accessible, affordable, and people-centered mental health services through district hospitals, PHCs, and community outreach programs.</p>
                                    </div>
                                </div>
                        ...
                        <div class="tabs-content">
                            <div class="tab active-tab" id="tab-1">
                                <div class="row align-items-center clearfix">
                                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                        <figure class="image-box"><img src="assets/images/resource/chooseus-1.jpg" alt="Community Mental Health"></figure>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                        <figure class="image-box"><img src="assets/images/resource/chooseus-2.jpg" alt="Community Outreach"></figure>
                                    </div>
                                </div>
                            </div>
                            <div class="tab" id="tab-2">
                                <div class="row align-items-center clearfix">
                                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                        <figure class="image-box"><img src="assets/images/resource/chooseus-1.jpg" alt="Government Partnership"></figure>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                        <div class="content_block_2">
                                            <div class="content-box">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                        <figure class="image-box"><img src="assets/images/resource/chooseus-2.jpg" alt="System Strengthening"></figure>
                                    </div>
                                </div>
                            </div>
                            <div class="tab" id="tab-3">
                                <div class="row align-items-center clearfix">
                                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                        <figure class="image-box"><img src="assets/images/resource/chooseus-1.jpg" alt="Holistic Care"></figure>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                        <div class="content_block_2">
                                            <div class="content-box">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                        <figure class="image-box"><img src="assets/images/resource/chooseus-2.jpg" alt="Holistic Recovery"></figure>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 case-block">
                        <div class="case-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-1.jpg" alt="Sunil's Recovery"></figure>
                                <div class="content-box">
                                    <div class="inner">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 case-block">
                        <div class="case-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-2.jpg" alt="Vandana's Recovery"></figure>
                                <div class="content-box">
                                    <div class="inner">
                                        <div class="icon-box"><i class="flaticon-brain"></i></div>
                        ...
                        <div class="case-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-3.jpg" alt="Gaurav's Recovery"></figure>
                                <div class="content-box">
                                    <div class="inner">
                                        <div class="icon-box"><i class="flaticon-brain"></i></div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 case-block">
                        <div class="case-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-4.jpg" alt="Vinay's Recovery"></figure>
                                <div class="content-box">
                                    <div class="inner">
                                        <div class="icon-box"><i class="flaticon-brain"></i></div>
        ...
        <!-- funfact-section -->
        <section class="funfact-section centred" style="background-image: url(assets/images/background/funfact-bg.jpg);">
            <div class="auto-container">
                <div class="sec-title light centred">
                    <i class="flaticon-brain-1"></i>
                    <h6>Our Achievements</h6>
                    <h2>Impact Numbers That Matter</h2>
                </div>
                <div class="row clearfix">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 counter-block">
                        <div class="counter-block-one wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="count-outer count-box">
                                    <span class="count-text" data-speed="1500" data-stop="15000">0</span><span>+</span>
                                </div>
                                <p>Patients Under Care</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 counter-block">
                ...
                <div class="row clearfix">
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="our-team.php"><img src="assets/images/team/team-1.jpg" alt="Psychiatrist"></a></figure>
                                <div class="designation">
                                    <h6>Psychiatrist</h6>
                                </div>
                                <div class="text">
                                    <h4><a href="our-team.php">Dr. Clinical Lead</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="our-team.php"><img src="assets/images/team/team-2.jpg" alt="Clinical Psychologist"></a></figure>
                                <div class="designation">
                                    <h6>Clinical Psychologist</h6>
                                </div>
                                <div class="text">
                                    <h4><a href="our-team.php">Counseling Lead</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="our-team.php"><img src="assets/images/team/team-3.jpg" alt="Program Manager"></a></figure>
                                <div class="designation">
                                    <h6>Program Manager</h6>
                                </div>
                                <div class="text">
                                    <h4><a href="our-team.php">Operations Lead</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="our-team.php"><img src="assets/images/team/team-4.jpg" alt="Community Health Worker"></a></figure>
                                <div class="designation">
                                    <h6>Community Health Worker</h6>
                                </div>
                                <div class="text">
                                    <h4><a href="our-team.php">Field Coordinator</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="news-updates.php"><img src="assets/images/news/news-1.jpg" alt="Mental Health Awareness"></a></figure>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="events.php"><img src="assets/images/news/news-2.jpg" alt="Community Awareness"></a></figure>
                                <div class="lower-content">
                                    <ul class="info clearfix">
                                        <li>Events</li>
                                        <li>/</li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="stories.php"><img src="assets/images/news/news-3.jpg" alt="Success Stories"></a></figure>
                                <div class="lower-content">
                                    <ul class="info clearfix">

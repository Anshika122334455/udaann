                ...
                <div class="slide-item">
                    ...
                    <div class="auto-container">
                        <div class="content-box">
                            ...
                            <h3> Clinical Psychology Experts In Mental Helth.</h3>
                            <h1><span>Dr.</span>Bankimon</h1>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                        <div class="case-block-two">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-9.jpg" alt=""></figure>
                                <div class="content-box">
                                    <div class="inner">
                                        <div class="icon-box"><i class="flaticon-brain"></i></div>
                                        <h3><a href="cases-details.html">Grief & Counseling</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                        <div class="case-block-two">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-10.jpg" alt=""></figure>
                                <div class="content-box">
                                    <div class="inner">
                                        <div class="icon-box"><i class="flaticon-brain"></i></div>
                                        <h3><a href="cases-details.html">Grief & Counseling</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                        <div class="case-block-two">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-11.jpg" alt=""></figure>
                                <div class="content-box">
                                    <div class="inner">
                                        <div class="icon-box"><i class="flaticon-brain"></i></div>
                                        <h3><a href="cases-details.html">Grief & Counseling</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                        <div class="case-block-two">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-12.jpg" alt=""></figure>
                                <div class="content-box">
                                    <div class="inner">
                                        <div class="icon-box"><i class="flaticon-brain"></i></div>
                                        <h3><a href="cases-details.html">Grief & Counseling</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                        <div class="case-block-two">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-13.jpg" alt=""></figure>
                                <div class="content-box">
                                    <div class="inner">
                                        <div class="icon-box"><i class="flaticon-brain"></i></div>
                                        <h3><a href="cases-details.html">Grief & Counseling</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 case-block">
                        <div class="case-block-two">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-14.jpg" alt=""></figure>
                                <div class="content-box">
                                    <div class="inner">
                                        <div class="icon-box"><i class="flaticon-brain"></i></div>
                                        <h3><a href="cases-details.html">Grief & Counseling</a></h3>
                        ...
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="designation">
                                    <h6>Family Psychology</h6>
                                </div>
                                <div class="text">
                                    <h4><a href="index.html">Joni Hasan Anik</a></h4>
                                    <ul class="social-links clearfix">
                                        <li><a href="index.html">Facebook</a></li>
                                        <li><a href="index.html">Twitter</a></li>
                                        <li><a href="index.html">Behance</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="text">
                                    <h4><a href="index.html">Towkibur Rahman</a></h4>
                                    <ul class="social-links clearfix">
                                        <li><a href="index.html">Facebook</a></li>
                                        <li><a href="index.html">Twitter</a></li>
                                        <li><a href="index.html">Behance</a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="text">
                                    <h4><a href="index.html">Kutubul Alam Putu</a></h4>
                                    <ul class="social-links clearfix">
                                        <li><a href="index.html">Facebook</a></li>
                                        <li><a href="index.html">Twitter</a></li>
                                        <li><a href="index.html">Behance</a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="text">
                                    <h4><a href="index.html">Mahi Al Mahin</a></h4>
                                    <ul class="social-links clearfix">
                                        <li><a href="index.html">Facebook</a></li>
                                        <li><a href="index.html">Twitter</a></li>
                                        <li><a href="index.html">Behance</a></li>
                    ...
                    <div class="auto-container">
                        ...
                        <div class="tab-btn-box">
                            <ul class="tab-btns tab-buttons centred clearfix">
                                <li class="tab-btn" data-tab="#tab-1">One To One Consultation</li>
                                <li class="tab-btn active-btn" data-tab="#tab-2">Family Consultation</li>
                                <li class="tab-btn" data-tab="#tab-3">Couple Consultation</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="auto-container">
                        <div class="tabs-content">
                            <div class="tab" id="tab-1">
                                <div class="row clearfix">
                                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                        <figure class="image-box mr-0"><img src="assets/images/resource/chooseus-3.jpg" alt=""></figure>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                        <div class="content_block_5">
                                            <div class="content-box">
                                                <h2>One Consultation Psychotherapy</h2>
                            ...
                            <div class="tab" id="tab-3">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                        <div class="content_block_5">
                                            <div class="content-box">
                                                <h2>Couple Consultation Psychotherapy.</h2>
                                                <h3>Therapy With Dr. Rafiqul Islam</h3>
                                                <p>Quam est auctor sem, eget cursus magna sapien vel nunc. Vivamus a imperdiet tellus, ut commodo justo sed dolor.</p>
                                                <a href="index-2.html" class="theme-btn btn-two">Read More</a>
                                            </div>

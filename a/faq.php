                        ...
                        <div class="content_block_6">
                            <div class="content-box">
                                <div class="sec-title">
                                    ...
                                    <h6>We Provide</h6>
                                    <h2>Have Questions? Get In Touch Or Look At The FAQ Section.</h2>
                                </div>
                                <div class="text">
                                    <p>Tempor nulla. Vestibulum dictum ante eu tortor faucibus, quis finibus justo dignissim. Vivamus sollicitudin neque quis mauris placebhfgrat porttitor. Proin gravida elit in nibh bibendum gravida. Suspfendisse potenti. Fusce velit eros, elementum quis sapien non,</p>
                                </div>
                                <figure class="image-box"><img src="assets/images/resource/faq-1.jpg" alt=""></figure>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="accordion-box">
                            <li class="accordion block active-block">
                                <div class="acc-btn active">
                                    ...
                                    <h5>What are some food questions?</h5>
                                </div>
                                <div class="acc-content current">
                                    <div class="content-box">
                                        <p>Nullam eget tempor nulla. Vestibulum dictum ante eu tortor faucibus, quis finibus justo dignissim. Vivamus sollicitudin neque quis mauris placebhfgrat porttitor. Proin gravida elit in nibh bibendum gravida. Suspfendisse potenti. Fusce velit eros, elementum quis sapien non, auctor scelerisque velit. Donec in dignissim orci.</p>
                                    </div>
                                </div>
                            </li>
                            <li class="accordion block">
                                <div class="acc-btn">
                                    <div class="icon-outer"><i class="far fa-plus"></i></div>
                                    <h5>What are good food and drink quiz questions?</h5>
                                </div>
                            ...
                            <li class="accordion block">
                                <div class="acc-btn">
                                    <div class="icon-outer"><i class="far fa-plus"></i></div>
                                    <h5>Which food a delicacy today, was working class food?</h5>
                                </div>
                                <div class="acc-content">
                                    <div class="content-box">
                                        <p>Nullam eget tempor nulla. Vestibulum dictum ante eu tortor faucibus, quis finibus justo dignissim. Vivamus sollicitudin neque quis mauris placebhfgrat porttitor. Proin gravida elit in nibh bibendum gravida. Suspfendisse potenti. Fusce velit eros, elementum quis sapien non, auctor scelerisque velit. Donec in dignissim orci.</p>
                            ...
                            <li class="accordion block">
                                <div class="acc-btn">
                                    <div class="icon-outer"><i class="far fa-plus"></i></div>
                                    <h5>What are churros traditionally served with?</h5>
                                </div>
                                <div class="acc-content">
                                    <div class="content-box">
                                        <p>Nullam eget tempor nulla. Vestibulum dictum ante eu tortor faucibus, quis finibus justo dignissim. Vivamus sollicitudin neque quis mauris placebhfgrat porttitor. Proin gravida elit in nibh bibendum gravida. Suspfendisse potenti. Fusce velit eros, elementum quis sapien non, auctor scelerisque velit. Donec in dignissim orci.</p>
                            ...
                            <li class="accordion block">
                                <div class="acc-btn">
                                    <div class="icon-outer"><i class="far fa-plus"></i></div>
                                    <h5>Which religion is Challah bread associated with?</h5>
                                </div>
                                <div class="acc-content">
                                    <div class="content-box">
                                        <p>Nullam eget tempor nulla. Vestibulum dictum ante eu tortor faucibus, quis finibus justo dignissim. Vivamus sollicitudin neque quis mauris placebhfgrat porttitor. Proin gravida elit in nibh bibendum gravida. Suspfendisse potenti. Fusce velit eros, elementum quis sapien non, auctor scelerisque velit. Donec in dignissim orci.</p>

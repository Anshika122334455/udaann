                    ...
                    <div class="upper-inner clearfix">
                        ...
                        <div class="header-info pull-right">
                            <ul class="info-list">
                                ...
                                <li>
                                    <h5>Mon - Sat <span>8:00 - 6:30</span></h5>
                                </li>
                                <li class="btn-box">
                ...
                <div class="auto-container">
                    <div class="outer-box clearfix">
                                    ...
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="dropdown"><a href="index.html">Pages</a>
                                            <ul>
                                                ...
                                                <li class="dropdown"><a href="index.html">Cases</a>
                                                    <ul>
                                                        <li><a href="cases.html">Case Study</a></li>
                                                        <li><a href="cases-details.html">Case Details</a></li>
                                                    </ul>
                                                </li>
                        ...
                        <div class="nav-right pull-right">
                            ...
                            <div class="shop-cart">
                                <a href="index.html"><i class="flaticon-add"></i><span>0</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="link">
                                    <a href="service-details.html"><i class="flaticon-right-arrow"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <h3><a href="service-details.html">Women's <br />Issues</a></h3>
                                <div class="link">
                                    <a href="service-details.html"><i class="flaticon-right-arrow"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <h3><a href="service-details.html">Self-Esteem Issues</a></h3>
                                <div class="link">
                                    <a href="service-details.html"><i class="flaticon-right-arrow"></i></a>
                                </div>
                            </div>
                                        ...
                                        <div class="content_block_3">
                                            <div class="content-box">
                                                <div class="text">
                                                    ...
                                                    <h3><i class="flaticon-quote"></i>Helthy Mind, Healthy You.</h3>
                                                    <p>Quam est auctor sem, eget cursus magna sapien vel nunc. Vivamus a imperdiet tellus, ut commodo justo sed dolor.</p>
                                                </div>
                                                <div class="btn-box">
                                                    <a href="index.html" class="theme-btn btn-two">Read More</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                        <figure class="image-box"><img src="assets/images/resource/chooseus-2.jpg" alt=""></figure>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 case-block">
                        <div class="case-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-1.jpg" alt=""></figure>
                                <div class="content-box">
                                    <div class="inner">
                                        <div class="icon-box"><i class="flaticon-brain"></i></div>
                                        <h2><a href="cases-details.html">Loss Counseling</a></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 case-block">
                        <div class="case-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-2.jpg" alt=""></figure>
                                <div class="content-box">
                                    <div class="inner">
                                        <div class="icon-box"><i class="flaticon-brain"></i></div>
                                        <h2><a href="cases-details.html">Loss Counseling</a></h2>
                        ...
                        <div class="case-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-3.jpg" alt=""></figure>
                                <div class="content-box">
                                    <div class="inner">
                                        <div class="icon-box"><i class="flaticon-brain"></i></div>
                                        <h2><a href="cases-details.html">Loss Counseling</a></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 case-block">
                        <div class="case-block-one">
                            <div class="inner-box">
                                <figure class="image-box"><img src="assets/images/gallery/case-4.jpg" alt=""></figure>
                                <div class="content-box">
                                    <div class="inner">
                                        <div class="icon-box"><i class="flaticon-brain"></i></div>
                                        <h2><a href="cases-details.html">Loss Counseling</a></h2>

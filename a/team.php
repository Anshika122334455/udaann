            ...
            <div class="auto-container">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="index.html"><img src="assets/images/team/team-5.jpg" alt=""></a></figure>
                                <div class="designation">
                                    <h6>Family Psychology</h6>
                                </div>
                                <div class="text">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="index.html"><img src="assets/images/team/team-6.jpg" alt=""></a></figure>
                                <div class="designation">
                                    <h6>Family Psychology</h6>
                                </div>
                                <div class="text">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="index.html"><img src="assets/images/team/team-7.jpg" alt=""></a></figure>
                                <div class="designation">
                                    <h6>Family Psychology</h6>
                                </div>
                                <div class="text">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="index.html"><img src="assets/images/team/team-8.jpg" alt=""></a></figure>
                                <div class="designation">
                                    <h6>Family Psychology</h6>
                                </div>
                                <div class="text">
                ...
                <div class="more-btn centred">
                    <a href="team.html" class="theme-btn btn-one">Load More</a>
                </div>
            </div>
        </section>
        <!-- team-section end -->
